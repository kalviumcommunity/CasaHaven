      ...
      content: [
        {
          ...
          text: "CasaHaven operates globally, and your information may be transferred to and processed in countries other than your own. We ensure appropriate safeguards are in place to protect your information in accordance with this privacy policy.",
        },
      ],
    },
    {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <p className="text-lg text-gray-600 mb-4">
            At CasaHaven, we are committed to protecting your privacy and
        ...
        {/* Contact Information */}
        <div className="bg-red-600 rounded-2xl p-8 mt-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <div className="bg-white bg-opacity-20 rounded-lg p-4">
              ...
              <p className="text-red-100">ashish@gmail.com</p>
            </div>
            <div className="bg-white bg-opacity-20 rounded-lg p-4">
              <h3 className="text-white font-semibold mb-2">Call Us</h3>
              <p className="text-red-100">+91 123456789</p>
            </div>
            <div className="bg-white bg-opacity-20 rounded-lg p-4">

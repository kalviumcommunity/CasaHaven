    ...
    <div className="card-modern overflow-hidden group animate-fade-in-up">
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute top-3 left-3 flex flex-col space-y-1">
          ...
          <span className="bg-red-600 text-white text-xs font-medium px-2 py-1 rounded-full capitalize">
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white text-sm font-semibold rounded-2xl hover:from-red-600 hover:to-red-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl animate-glow">
            View Details
          </div>
        </div>
      </Link>

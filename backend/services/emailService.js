...
const createTransporter = () => {
  return nodemailer.createTransporter({
    service: 'gmail',
    auth: {
      user: process.env.EMAIL_USER || 'ashupatil1357@gmail.com',
...
const sendSupportQueryNotification = async (queryData) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_USER || 'ashupatil1357@gmail.com',
      to: 'ashupatil1357@gmail.com',
      subject: `RestNest Support Query: ${subject}`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 20px; border-radius: 10px 10px 0 0; text-align: center;">
            <h1 style="margin: 0; font-size: 24px;">🏠 RestNest Support Query</h1>
          </div>
          ...
          <div style="background: #333; color: white; padding: 15px; border-radius: 0 0 10px 10px; text-align: center; font-size: 12px;">
            <p style="margin: 0;">This is an automated notification from RestNest Support System</p>
...
const sendAutoReplyToCustomer = async (customerData) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_USER || 'ashupatil1357@gmail.com',
      to: email,
      subject: `Re: ${subject} - RestNest Support [Ticket Received]`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 20px; border-radius: 10px 10px 0 0; text-align: center;">
            <h1 style="margin: 0; font-size: 24px;">🏠 RestNest Support</h1>
          </div>
          ...
          <div style="padding: 20px;">
            ...
            <p style="color: #666; line-height: 1.6;">
              Thank you for contacting RestNest Support! We have received your query and our team will get back to you within <strong>2 hours</strong>.
            </p>
            ...
            <p style="color: #666; line-height: 1.6;">
              Best regards,<br>
              <strong>RestNest Support Team</strong><br>
              📧 ashupatil1357@gmail.com<br>
              📞 +91 8871900963
            </p>
          </div>
          ...
          <div style="background: #f8f9fa; padding: 15px; border-radius: 0 0 10px 10px; text-align: center; font-size: 12px; color: #666;">
            ...
            <p style="margin: 5px 0 0 0;">For immediate assistance, contact us directly at ashupatil1357@gmail.com</p>
          </div>
        </div>
      `
    };

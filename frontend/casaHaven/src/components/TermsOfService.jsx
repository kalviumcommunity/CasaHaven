      ...
      content: [
        {
          ...
          text: "By accessing or using CasaHaven's platform, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using our services.",
        },
        {
          subtitle: "Eligibility",
          text: "You must be at least 18 years old to use our services. By using CasaHaven, you represent and warrant that you have the legal capacity to enter into these terms and comply with all applicable laws.",
        },
      ],
    },
    {
      ...
      content: [
        {
          ...
          text: 'CasaHaven is an online platform that connects travelers ("Guests") with property owners and managers ("Hosts") who offer accommodations for short-term rental. We facilitate bookings but are not a party to the rental agreements between Hosts and Guests.',
        },
        {
          subtitle: "Platform Role",
          text: "CasaHaven acts as an intermediary platform. We do not own, operate, manage, or control any properties listed on our platform. Hosts are responsible for their listings, and Guests are responsible for their bookings and conduct.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: "Currently, payment arrangements are made directly between Guests and Hosts. CasaHaven facilitates the booking process but does not process payments. We're working on implementing secure payment processing in the future.",
        },
        {
      ...
      content: [
        {
          ...
          text: "CasaHaven owns or licenses all content on our platform, including text, graphics, logos, and software. Users may not copy, modify, or distribute our content without permission.",
        },
        {
          subtitle: "User Content",
          text: "Users retain ownership of content they post but grant CasaHaven a license to use, display, and distribute such content for platform operations and marketing purposes.",
        },
      ],
    },
    {
      ...
      content: [
        {
          ...
          text: 'CasaHaven provides the platform "as is" without warranties. We are not liable for the actions of Hosts or Guests, property conditions, or issues arising from rental agreements.',
        },
        {
          subtitle: "Damage Limitation",
          text: "Our liability is limited to the amount of fees paid to CasaHaven for the specific booking in question. We are not liable for indirect, incidental, or consequential damages.",
        },
      ],
    },
    {
      ...
      content: [
        {
          ...
          text: "We encourage users to resolve disputes directly. If needed, CasaHaven may mediate disputes and make determinations regarding refunds, cancellations, or other issues.",
        },
        {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <p className="text-lg text-gray-600 mb-4">
            These Terms of Service govern your use of the CasaHaven platform and
            services.
          </p>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-yellow-700">
                ...
                using CasaHaven, you agree to be bound by these terms. If you do
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            {sections.map((section, index) => (
              <a
                key={index}
                href={`#section-${index}`}
                className="text-red-600 hover:text-red-700 hover:underline py-1"
              >
        ...
        {/* Contact and Updates */}
        <div className="bg-red-600 rounded-2xl p-8 mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white bg-opacity-20 rounded-lg p-4 text-center">
              ...
              <p className="text-red-100 text-sm">ashish@gmail.com</p>
            </div>
            <div className="bg-white bg-opacity-20 rounded-lg p-4 text-center">
            ...
            <div className="bg-white bg-opacity-20 rounded-lg p-4 text-center">
              ...
              <p className="text-red-100 text-sm">+91 123456789</p>
            </div>
          </div>

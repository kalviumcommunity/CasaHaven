...
const Support = () => {
  ...
  const faqs = [
    {
      category: "booking",
              question: "How do I book a property on CasaHaven?",
      answer:
    ...
    {
      category: "hosting",
              question: "How do I become a host on CasaHaven?",
      answer:
    ...
    {
      category: "hosting",
              question: "What percentage does CasaHaven take from bookings?",
      answer:
          "CasaHaven charges a 3% service fee from hosts for each completed booking. This covers payment processing, customer support, insurance coverage, and platform maintenance. There are no upfront costs or monthly fees.",
    },
    {
      category: "hosting",
    ...
    {
      category: "safety",
              question: "How does CasaHaven ensure guest and host safety?",
      answer:
    ...
    },
    {
      ...
      answer:
        "For immediate emergencies, contact local emergency services (911, 112, etc.). For CasaHaven-related urgent issues, call our 24/7 emergency line at +91 123456789. We have dedicated safety specialists available around the clock.",
    },
    {
      category: "account",
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-red-600 hover:text-red-700 font-medium text-sm hover:underline transition-all"
                >
                  {option.action} →
                </button>
              </div>
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
                className="bg-white text-red-600 py-4 px-8 rounded-2xl font-semibold hover:bg-gray-50 transform hover:scale-105 transition-all duration-300 shadow-lg"
              >
                Contact Support
              </Link>

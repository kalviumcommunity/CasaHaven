                    ...
                    <div className="relative">
                      {user.profilePicture ? (
                        <img
                          ...
                          onError={e => { e.target.onerror = null; e.target.style.display = 'none'; e.target.parentNode.innerHTML = `<div class=\"w-20 h-20 rounded-full bg-red-100 flex items-center justify-center border-4 border-white shadow-lg\"><span class=\"text-red-600 text-3xl font-bold\">${user?.name?.charAt(0).toUpperCase() || '?'}</span></div>`; }}
                        />
                      ) : (
                        <div className="w-20 h-20 rounded-full bg-red-100 flex items-center justify-center border-4 border-white shadow-lg">
                          <span className="text-red-600 text-3xl font-bold">{user?.name?.charAt(0).toUpperCase()}</span>
                        </div>
                      )}

...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative lg:block">
              <div className="relative">
                ...
                {/* Floating Cards */}
                <div className="absolute -bottom-3 -left-3 glass bg-white/90 backdrop-blur-md rounded-2xl p-4 shadow-2xl border border-red-200 animate-float">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-xs font-semibold text-gray-900">Verified Host</div>
                      <div className="text-xs text-gray-500">100% Trusted</div>
                    </div>
                  </div>
                </div>

                <div className="absolute -top-3 -right-3 glass bg-red-100/90 backdrop-blur-md rounded-2xl p-4 shadow-2xl border border-red-200 animate-float" style={{ animationDelay: "2s" }}>
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-xs font-semibold text-red-700">4.9 Rating</div>
                      <div className="text-xs text-red-500">2,847 reviews</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {features.map((feature, index) => (
                <div
                  key={feature.name}
                  className="group relative card-modern p-8 border border-gray-200/50 hover:border-red-300/50 shadow-lg hover:shadow-red-200/50 animate-fade-in-up"
                ...
                >
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-center h-16 w-16 rounded-2xl bg-gradient-to-br from-red-500 via-red-400 to-white text-white shadow-xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 animate-glow">
                      {React.cloneElement(feature.icon, {
                        className: "h-8 w-8",
                      })}
                    </div>

                    <h3 className="mt-6 text-xl font-bold text-gray-900 group-hover:text-red-600 transition-colors duration-300">
                      {feature.name}
                    </h3>
      ...
      {/* CTA Section */}
      <div className="relative bg-gradient-to-br from-red-600 via-red-400 to-white overflow-hidden">
        {/* Background Elements */}
